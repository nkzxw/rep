...
/* Define to 1 if `struct in6_addr' is a member of `s6_addr16'. */
#define EVENT__HAVE_STRUCT_IN6_ADDR_S6_ADDR16 1

/* Define to 1 if `struct in6_addr' is a member of `s6_addr32'. */
...
/* Define to 1 if `struct sockaddr_storage' is a member of `ss_family'. */
#define EVENT__HAVE_STRUCT_SOCKADDR_STORAGE_SS_FAMILY 1

/* Define to 1 if `struct sockaddr_storage' is a member of `__ss_family'. */
